...
namespace EFCoreWithAsp.netCore.Controllers
{
    ...
    {
        private readonly ITeacherrepo _employeeRepository;

        //Dependency injection
        public TeacherController(ITeacherrepo employeeRepository)
        {
        ...
        public async Task<IActionResult> Index(string searchString, string sortOrder, int pageNumber, string currentFilter)
        {
            ...
            int pageSize = 5;
            return View(await PaginatedList<TeacherViewModel>.CreateAsync(employees, pageNumber, pageSize));
        ...
        //POST: Employee/Edit
        [HttpPost]
        public async Task<IActionResult> Edit(TeacherViewModel employee)
        {
